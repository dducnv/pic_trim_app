...
import 'package:pic_trim_app/core/utils/enum.dart';
import 'package:pic_trim_app/core/utils/extended_pan_detector.dart';
import 'package:pic_trim_app/core/mask/mask.dart';
import 'package:pic_trim_app/core/mask/options.dart';
import 'package:pic_trim_app/core/utils/crop.dart';
...
class _CropPreviewState extends State<CropPreview> {
  ...
  late PicTrimController _controller;
  ...
  void initState() {
    super.initState();
    _controller = (widget.controller ?? PicTrimController())
